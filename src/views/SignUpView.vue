...
<template>
  <div class="w-full flex flex-col justify-center items-center p-5 h-screen">
    <div class="flex flex-col w-md gap-1.5">
      <h1 class="self-start">Registracijska forma</h1>
    ...
    <div class="w-md border-gray-500 p-5 h-auto shadow-md border-md flex flex-col gap-2.5">
      <div class="w-full flex flex-col gap-1">
        ...
        <input type="text" class="border rounded-md h-8" v-model="username" />
      </div>
      <div class="w-full flex flex-col gap-1">
        <label>Email</label>
        <input type="text" class="border rounded-md h-8" v-model="email" />
      </div>
      <div class="w-full flex flex-col gap-1">
        <label>Lozinka</label>
        <input type="text" class="border rounded-md h-8" v-model="password" />
      </div>
      <div class="w-full flex flex-col gap-1">
        <label>Ponovi lozinku</label>
        <input type="text" class="border rounded-md h-8" v-model="repeatedPassword" />
      </div>
